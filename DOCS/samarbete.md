...
Ett gemensamt repository är något man kan på till exempel *GitHub*.
Där lagras all kod och all historik på de commits som har gjorts från alla kodare i ett projekt.
